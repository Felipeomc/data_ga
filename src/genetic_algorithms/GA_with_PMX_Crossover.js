...
//fs.writeFile('sugestoes_cross_pmx_5_6_8_100_0005.csv', csvData, 'utf8', err => {
  //if (err) {
...
console.log(`Tempo de Execução do AG pmx: ${end[0]} segundos e ${end[1] / 1000000} milissegundos`);
