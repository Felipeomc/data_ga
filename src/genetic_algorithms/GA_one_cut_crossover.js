...
fs.writeFile('rodada_ag_onecut_40.csv', csvData, 'utf8', err => {
  if (err) {
...
// Salvar o CSV em um arquivo
//fs.writeFile('sugestoes_simples_4_10_7_100_0005.csv', csvData, 'utf8', err => {
 // if (err) {
 //   console.error('Erro ao salvar o arquivo CSV:', err);
 // } else {
 //   console.log('Arquivo sugestoes_simples.csv CSV salvo com sucesso.');
 // }
//});
...
console.log('ag simples');



const end = process.hrtime(start);
console.log(`Tempo de Execução do AG simples: ${end[0]} segundos e ${end[1] / 1000000} milissegundos`);